...
flags.DEFINE_string('input_csv', '/home/eshi/Documents/polygence/github/poem/img/input_file.csv', 'Path to input CSV file.')
flags.mark_flag_as_required('input_csv')

flags.DEFINE_string('output_dir', '/home/eshi/Documents/polygence/github/poem/img/embeddings', 'Path to output directory.')
